...
-- =========================================================
-- LESSON 18 : STRING FUNCTIONS
-- =========================================================

-- =========================================================
-- QUERY 74
-- QUESTION:
-- Display all customer names in UPPERCASE letters.
--
-- TOPIC:
-- UPPER()
--
-- ERP USE CASE:
-- Used to standardize customer, vendor,
-- item and account names for reporting.
-- =========================================================
...
-- QUERY 75
-- QUESTION:
-- Display all customer names in lowercase letters.
--
-- TOPIC:
-- LOWER()
--
...
-- QUERY 76
-- QUESTION:
-- Display each customer name along with
...
--
-- ERP USE CASE:
-- Used for data validation, field size checking
...
-- QUERY 77
-- QUESTION:
-- Display the first 3 characters of each
-- customer name.
--
-- TOPIC:
-- LEFT()
--
-- ERP USE CASE:
-- Used for customer code generation,
-- abbreviations and reporting formats.
-- =========================================================
...
-- QUERY 78
-- QUESTION:
-- Display the last 2 characters of each
-- customer name.
--
-- TOPIC:
-- RIGHT()
--
-- ERP USE CASE:
-- Used for suffix extraction,
-- code analysis and text parsing.
-- =========================================================
...
-- QUERY 79
-- QUESTION:
-- Combine customer name and customer ID
-- into a single text value using CONCAT().
--
-- EXAMPLE:
-- Rahim-1
-- Karim-2
...
--
-- ERP USE CASE:
-- Used for generating display labels,
-- report captions and combined identifiers.
-- =========================================================
...
-- QUESTION:
-- Combine customer name and customer ID
-- into a single text value using the
...
--
-- ERP USE CASE:
-- Frequently used in PostgreSQL reports,
-- Crystal Reports source queries and ERP reporting.
-- =========================================================
